...
var Tooltip = React69.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React69.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime77.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime77.jsxs)(React69.Fragment, {
    children: [React69.cloneElement(children, childrenProps), (0, import_jsx_runtime77.jsx)(PopperSlot, {
...
var Step = React74.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime81.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime81.jsxs)(React74.Fragment, {
...
var StepButton = React77.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React77.cloneElement(children, childProps) : (0, import_jsx_runtime86.jsx)(StepLabel_default, {
    ...childProps,
    children
  });
...
var SwipeableDrawer = React82.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime91.jsxs)(React82.Fragment, {
